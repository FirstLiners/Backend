...
class Store(models.Model):
    ...
    type_loc_id = models.PositiveIntegerField("Тип локации магазина",)
    type_size_id = models.PositiveIntegerField("Тип размера магазина",)
    is_active = models.PositiveIntegerField("Активени ли магазин",)
