...
data2 = data[(data['st_id_key'] == '084a8a9aa8cced9175bd07bc44998e75') &
...
def forecast(store_id: str, sku_id: str) -> List[int]:
    ...
    data2 = data[(data["st_id_key"] == store_id) &
                 (data["pr_sku_id_key"] == sku_id)]

    data2 = data2.drop(
        ["date", "date.1", "st_id_key", "pr_sku_id_key"],
        axis=1
    )
